...
from psystack.tui.widgets.help_overlay import HelpOverlay
from psystack.tui.widgets.live_run_monitor import LiveRunMonitor
from psystack.tui.widgets.progress_summary import ProgressSummary
...
class InvestigationScreen(Screen):
    ...
    def action_run_evaluation(self) -> None:
        ...
        from psystack.tui.state import CaseState
    ...
    def action_cycle_live_view(self) -> None:
        ...
        ws = app.state.current_workspace
        if ws:
            from psystack.pipeline.workspace import read_workspace_state, write_workspace_state
    ...
    def action_open_evidence(self) -> None:
        from psystack.tui.screens.drawers.evidence_drawer import EvidenceDrawer
    ...
    def action_open_context(self) -> None:
        from psystack.tui.screens.drawers.context_drawer import ContextDrawer
